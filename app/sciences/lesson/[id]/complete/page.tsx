...
import { getLessonById } from '@/src/data/sciencesLessons';
import BackToLessonsButton from '@/src/components/BackToLessonsButton';

export default function SciencesLessonCompletePage() {
  ...
  // Debug logging
  console.log('Sciences complete page loaded:', { score, lessonId, lesson: !!lesson, scoreParam });
  ...
  if (!scoreParam) {
    ...
    router.push(`/sciences/lesson/${lessonId}`);
    return null;
  }
      ...
      <div className="w-full max-w-xs mb-6">
        <div className="card flex flex-col items-center justify-center py-6 px-4 w-full">
          ...
          <div className="flex flex-col gap-3 w-full">
            <Link href={`/sciences/lesson/${lessonId}`}>
          ...
          <div className="card flex flex-col py-6 px-4 w-full">
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="flex-1">
                <h4 className="text-base font-semibold text-white">Mécanique et Mouvement</h4>
                <p className="text-white/80 text-sm">Forces, mouvement, énergie mécanique</p>
              </div>
            </div>
            <Link href="/sciences/lesson/2">
